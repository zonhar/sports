			...
			<view class="content-body">
				...
				<view class="footer flex-center">
					<view class="progress-box flex-column" v-if="!updateBtn">
						<progress class="progress" border-radius="35" :percent="percent" activeColor="#D42C33" show-info stroke-width="10" />
...
.content-button {
	...
	background: linear-gradient(to right, #D52E37, #D52E37);
}
